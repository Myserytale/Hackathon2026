  ...
  Future<void> _submit() async {
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Cont administrator creat cu succes! Autentificați-vă cu emailul.'),
    ...
    return RoeidAuthLayout(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text('Înregistrare admin', style: Theme.of(context).textTheme.headlineSmall),
            const SizedBox(height: 8),
            Text(
              'Creați un cont pentru portalul de administrație APIA.',
